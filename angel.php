...
<head>
    <meta charset="utf-8">
    <title>Angel program dashboard</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"></i>Angel patients</h3>
                </a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Angel patients Categories</h6>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>12</td>
                                        <th scope="row">Wait list</th>
                                        <td>12</td>
                                        <th scope="row">Discharged</th>
                                        <td>123</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>12</td>
                                        <th scope="row">Attached to care</th>
                                        <td>12</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>12</td>
                                        <th scope="row">Completed treament</th>
                                        <td>12</td>
                                        <th scope="row">Dettached</th>
                                        <td>789</td>
                                        <th scope="row">Not needed</th>
                                        <td>789</td>
                                    </tr>
                                    <tr>
                                        <th></th>
                                        <td></td>
                                        <th scope="row">Load remaining</th>
                                        <td>789</td>
                                        <th></th>
                                        <td></td>
                                        <th scope="row">Witthout</th>
                                        <td>789</td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="row g-4">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <th scope="row">Male</td>
                                        <td>13</td>
                                        <td>1000000</td>
                                    </tr>
                                    <tr>
                                        
                                        <th scope="row">Female</td>
                                        <td>14</td>
                                        <td>1000000</td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Age group and Cost</h6>
